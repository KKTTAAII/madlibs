...
words = {
    'Once Upon A Time...': ["place", "noun", "verb", "adjective", "plural_noun"],
    'My Love Story': ["noun", "adverb", "verb", "adjective"],
...
def story_form():
    ...
    return render_template('storyform.html', select=select_template, words=word)
...
def show_story():
    ...
    return render_template('story.html', story=my_story, template=select_template)
